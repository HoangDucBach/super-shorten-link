...
import { WriteShortLinkToReadDatabaseUseCases } from 'src/applications/use-cases/short-link.usecase';

@EventsHandler(ShortLinkCreatedEvent)
export class ShortLinkToReadDatabaseHandler implements IEventHandler<ShortLinkCreatedEvent> {
    constructor(
